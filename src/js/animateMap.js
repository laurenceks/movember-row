...
import {coordinates, progressRoute, remainingRoute, route} from "./geoData.js";
import greatCircle from "@turf/great-circle";

const animateMap = (map, distance = 0, scrolledIntoView = null, durationInMs = 3000, progressMarkerMapBoxGl) => {
    ...
    const progressAnimation = (timestamp) => {
        ...
        const progressMarkerCoordinates = along(linestring(route.data.geometry.coordinates), distance * progressPercent,
